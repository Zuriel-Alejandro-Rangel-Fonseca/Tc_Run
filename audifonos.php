    ...
    <div class="container">
        ...
        <div class="row border shadow mb-5">
            ...
            <div class="col-sm-12 col-lg-2 d-flex justify-content-around d-lg-block mt-2">
                <img src="img/audifonos/img-audifonos-01.jpg" class="img-thumbnail mb-2 mr-0 w-25 d-lg-block" alt="">
                <img src="img/audifonos/img-audifonos-02.jpg" class="img-thumbnail mb-2 w-25 d-lg-block" alt="">
                <img src="img/audifonos/img-audifonos-03.jpg" class="img-thumbnail mb-2 w-25 d-lg-block" alt="">
            </div>

    ...
    <div class="container">
        ...
        <div class="row border shadow mb-5">
            ...
            <div class="col-sm-12 col-lg-2 d-flex justify-content-around d-lg-block mt-2">
                <img src="img/bandas/img-banda-01.jpg" id="img1" class="img-thumbnail mb-2 border-primary mr-0 w-25 d-lg-block" alt="">
                <img src="img/bandas/img-banda-02.jpg" id="img2" class="img-thumbnail mb-2 w-25 d-lg-block" alt="">
                <img src="img/bandas/img-banda-03.jpg" id="img3" class="img-thumbnail mb-2 w-25 d-lg-block" alt="">
            </div>
